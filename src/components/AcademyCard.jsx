...
export default function AcademyCard({ academy }) {
  ...
  return (
    <Link href={`/academias/${id}`}>
      <div className="card-hover bg-gradient-to-b from-dark-card to-dark-card2 rounded-xl border border-theme-border/5 p-5 transition-all duration-300 hover:border-blue-500/30 group">
